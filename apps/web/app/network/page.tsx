...
import { ChatUserProfile, SimpleUser } from "@lib/types"; // This SimpleUser is now the updated one
  ...
  useEffect(() => {
    ...
    const fetchUserProfile = async () => {
      ...
      try {
        ...
        setUserRooms(profile.rooms || []); // This now expects rooms with lastMessage
    ...
    const fetchDmConversations = async () => {
      try {
        ...
        // This type now correctly expects the new fields
